// To parse this data:
//
//   import { Convert, SpaceXAPIResponse } from './file';
//
//   const spaceXAPIResponse = Convert.toSpaceXAPIResponse(json);
//
...
export class Convert {
  public static toSpaceXAPIResponse (json: string): SpaceXAPIResponse {
    return cast(JSON.parse(json), r('SpaceXAPIResponse'))
  }

  public static spaceXAPIResponseToJson (value: SpaceXAPIResponse): string {
    return JSON.stringify(uncast(value, r('SpaceXAPIResponse')), null, 2)
  }
}
